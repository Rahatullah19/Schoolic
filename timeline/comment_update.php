...
<?php
   if(!empty($_POST['comment']) && !empty($_POST['act_id']) && !empty($_POST['user_hm_id'])) {
...
<li id="li-comment-<?php echo $ins_id; ?>">
   ...
   <div class="acomment-meta">
      <a href="../profile/pro.php?user_id=<?php echo $post_cmt_hm_id/2+5; ?>"><?php echo $cmt_hm_fullname; ?></a>  0 sec ago 
   </div>
