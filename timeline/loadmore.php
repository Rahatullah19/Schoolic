...
$result = mysqli_query($connection, "SELECT * FROM `posts` WHERE `block` <> 1 AND ($construct `post_hm_id` = $user_hm_id) AND `pid` < $last_post_id ORDER BY `pid` DESC LIMIT $post_limit"); 
...
?>
        ...
        <div class="imageUnit-content">
          <h4>
            <a href="pro.php?user_id=<?php echo $row['post_hm_id']/2+5; ?>">
              <?php echo $post_hm_name; ?> 
            </a>
            <?php if($_SESSION['hm_id'] != $row['post_hm_id']){?>
            <a href="javascript:;" onClick="parent.toChat('<?php echo $row['post_hm_id']/2+5; ?>')" title="Chat with <?php echo $post_hm_name; ?>">
...
?>
        ...
        <div class="acomment-meta">
          <a href="pro.php?user_id=<?php echo $user_hm_id/2+5; ?>">
            <?php echo $hm_name; ?>
          </a>  
          <?php echo timeAgo($comt['commented_date']);?> 
        </div>
...
?>
        ...
        <div class="acomment-meta">
          <a href="pro.php?user_id=<?php echo $comt['cmt_hm_id']/2+5; ?>">
            <?php echo $cmt_hm_name; ?>
          </a>  
          <?php echo timeAgo($comt['commented_date']);?> 
        </div>
