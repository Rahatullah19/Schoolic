...
$viewer_user_hm_name = $viewer_hm_info['first_name'] . " ". $viewer_hm_info['last_name'];
...
$user_hm_name = $user_first_name . " " . $user_last_name;
...
$user_hm_name = $user_first_name . " " . $user_last_name;
$user_profile_pic = $user_hm_info['profile_pic'];
//$access is for personal profile edit
$access = 1;
}
//fetching the friend list of the logged user
$user_friend_list = array();
$user_friend_list = friendList($_SESSION['hm_id']);
//fetching the block list of the logged user
$user_block_list = array();
$user_block_list = blockList($_SESSION['hm_id']);
if(in_array($user, $user_block_list)){
$restrict = 1;
}
else{
$restrict = 0;
}
//fetching the oldHm list of the logged user
$old_hm_list = array();
$old_hm_list = oldHmList($_SESSION['hm_id']);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <table>
              <tr class="profile_info">
                <td>
                  ...
                  <img class="w3-round" id="hm_dp" src="../images/profile_pic/<?php echo $viewer_user_profile_pic; ?>" style="float:left; width:60px; height:60px; margin:10px;" >
                  <?php 
}else{
...
?>
                ...
                <td>
                  <table>
                    <tr>
                      <td>
                        <a href="../profile/pro.php?user_id=<?php echo $viewer_user_hm_id/2+5; ?>">
                          <p id="hm_name" style="text-transform:capitalize;">
                            <b>
                              <?php echo $viewer_user_hm_name;?>
                            </b>
                          </p>
                        </a>
                      </td>
                    ...
                    <tr>
                      <td>
                        <a href="../timeline/schoolic.php" style="font-size:12px;">
            ...
            <?php if($viewer_hm_info['address1'] != "" ){?>
            <p>
              <i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme">
              </i> 
              <?php echo $viewer_hm_info['address1']; ?>
            </p>
            <?php } 
if($viewer_hm_info['country'] != "") {?>
            <p>
              <i class="fa fa-home fa-fw w3-margin-right w3-text-theme">
              </i> 
              <?php echo $viewer_hm_info['city']; ?>, 
              <?php echo $viewer_hm_info['country']; ?>
            </p>
            <?php } 
if($viewer_hm_info['d_o_b'] != 0000-00-00) {?>
            <p>
              <i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme">
              </i> 
              <?php echo $viewer_hm_info['d_o_b']; ?>
            </p>
            <?php } ?>
          </div>
        </div>
...
<?php if ($viewer_hm_info['profile_type'] != "4" && $viewer_hm_info['profile_type'] != "5" && $viewer_hm_info['profile_type'] != "6")
{ ?>
            <br>
            <div id="my_school">
            </div>
...
<?php if ($viewer_hm_info['profile_type'] == "2")
{ ?>
...
<?php if ($viewer_hm_info['profile_type'] != "5" && $viewer_hm_info['profile_type'] != "6")
{ ?>
        <!-- Interests -->
...
<?php if ($viewer_hm_info['profile_type'] != "6")
{ ?>
        <div class="w3-card-2 w3-round w3-white">
          <div class="w3-container">
            <p>My Subjects</p>
    ...
    <nav class="w3-sidenav w3-collapse w3-white w3-animate-right" style="z-index:400;width:490px;right:0;" id="mySidenav2">
      ...
      <div class="col-sm-13">
        <div class="col-sm-5" id="fri_box">
          <div class="w3-card-2">
            School Holics 
            <!--<a href="#" id="find_friend" style="font-size:12px; float:right"><span class="glyphicon glyphicon-search"></span> Find Friend</a>-->
            <div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapse_chat4" class="panel-collapse collapse">
                <div class="panel-body" style="padding:0px;">
                  <?php
$swap_hm = swapBox($_SESSION['hm_id']);
...
<!-- !PAGE CONTENT! -->
<div class="w3-main col-lg-6" style="margin-top:10px; margin-right:315px; margin-left:285px;">
  <div class="w3-col">
    <br>
    ...
    <!-- First Container -->
    <div id="who" class="container-fluid bg-1" style="background-image:url(../images/photo-1470338538299-d938bcb97f43.jpg); background-size:100%; background-position:center; background-repeat:no-repeat;">
      <?php if(!empty($user_profile_pic)){ ?>	
      <img src="../images/profile_pic/<?php echo $user_profile_pic; ?>" class="img-responsive img-circle" alt="Profile Picture" width="80" height="80">
      <?php
}else{
echo '<img src="../images/icon/male.jpg" class="img-responsive img-circle" alt="Profile Picture" width="80" height="80">';
} ?>
      <br>
      <p style="text-transform:capitalize;">
        <?php echo $user_hm_name; ?>
      </p>
      <?php
$hm_id = $_SESSION['hm_id'];
if($_SESSION['hm_id']!= $user_hm_id){
$result = mysqli_query($connection,"SELECT `status`, `action_user_id` FROM `hm_friend` WHERE (`user_id_1` = $hm_id AND `user_id_2` = $user_hm_id) OR (`user_id_1` = $user_hm_id AND `user_id_2` = $hm_id)" );
if(mysqli_num_rows($result) != 0){
$row = mysqli_fetch_array($result);
if(($restrict == 1) && $row['action_user_id']!=$_SESSION['hm_id']){ ?>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,5)" id="addFriendBtn">
        <span class="glyphicon glyphicon-plus">
        </span> Holics
      </a>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,3)" id="blockBtn3" title="Block Holics">
        Block
      </a>
      <?php }elseif(($row['status'] == 2) && $row['action_user_id']==$_SESSION['hm_id']){ ?>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,5)" id="addFriendBtn">
        <span class="glyphicon glyphicon-plus">
        </span> Holics
      </a>
      ...
      <?php }elseif(($row['status'] == 0) && $row['action_user_id']==$_SESSION['hm_id']){ ?>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,2)" id="addFriendBtn">
        Cancel Request
      </a>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,3)" id="blockBtn3" title="Block Holics">
        Block
      ...
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,2)" id="blockBtn4" title="Cancel Request">
        Ignore
      </a>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,3)" id="blockBtn3" style="display:none;" title="Block Holics">
        Block
      </a>
      <?php }	
}
if(in_array($user, $user_friend_list)){ ?>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,4)" id="addFriendBtn">
        <span class="glyphicon glyphicon-minus">
        </span> Holics
      </a>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,3)" id="blockBtn" title="Block Holics">
        Block
      </a>
      <?php }elseif(!in_array($user, $old_hm_list)){ ?>
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,4)" id="addFriendBtn">
        <span class="glyphicon glyphicon-plus">
        </span> Holics
      </a>
...
elseif($restrict == 1){?>
      ...
      <a href="#" class="btn btn-default btn-sm" onClick="addHm(<?php echo $_SESSION['hm_id']; ?>,<?php echo $user_hm_id; ?>,3)" id="blockBtn1" style="display:none;" title="Block Holics">
        Block
      </a>
      <?php }
} 
if($_SESSION['hm_id'] != $user){?>
      <a href="#" onClick="toChat('<?php echo $user/2+5; ?>')" class="btn btn-default btn-sm" title="Send message">
        <span class="glyphicon glyphicon-envelope">
        </span> Message
      </a>
      <?php } else{ ?>
      <a href="#" onClick="toChat1()" class="btn btn-default btn-sm" title="Send message">
        <span class="glyphicon glyphicon-envelope">
        </span> Message
      </a>
      <?php } if(isset($access)){ 
echo '<a href="../hm_profile.php" class="btn btn-default btn-sm" title="Edit profile"><span class="glyphicon glyphicon-edit"></span> Edit</a>';
} ?>
    </div>
    <!-- Second Container -->
    <div id="what" class="container-fluid bg-2">
      <p>
        <?php echo $user_hm_info['about_me']; ?>
      </p>
      <p>Mobile no.:-
        <?php echo $user_hm_info['mobile_no1']; ?>
      </p>
      <!--
...
<?php if(isset($access)){
echo '<a href="#" class="btn btn-default btn-sm" title="Edit about section"><span class="glyphicon glyphicon-edit"></span> Edit</a>';
} ?>
-->
    </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body" align="center">
            <button class="btn btn-default btn-lg">Share with all your Holics
            </button>
            <p>
            </p>
            <span> Or 
            ...
            <button class="btn btn-default btn-lg">Share with some of your Holics
            </button>
          </div>
...
<?php
$query="SELECT * FROM `posts` WHERE `post_hm_id` = $user_hm_id AND `block` = 0 ORDER BY `pid` DESC LIMIT $post_limit";
$result = mysqli_query($connection , $query);
$no_post = 0;
if(mysqli_num_rows($result) !=0){
$no_post = 1;
echo '<pre class="col-lg-12 text-center" style="background-color:#CCCCCC;"><h4>Posts</h4></pre>';
}
?>
...
?>
          ...
          <div class="imageUnit-content">
            <h4>
              <a href="pro.php?user_id=<?php echo $row['post_hm_id']/2+5; ?>" style="text-transform:capitalize;">
...
?>
          <li class="show-all" id="show-all-<?php echo $post_id; ?>" 
              <?php if($total_comments == 0) { ?> style="display:none" 
          <?php } ?>>
          <a href="javascript:;">
...
?>
        ...
        <!--
<a href="#" class="btn btn-default btn-sm" onClick="addShare(<?php echo $_SESSION['hm_id']/2+5; ?>,<?php echo $post_id; ?>,5)" id="addFriendBtn">
Share <span style="color:#00FF00;" class="glyphicon glyphicon-share"></span>
</a>-->&nbsp;&nbsp;
        <?php $like_count_result = queryMysql("SELECT `like_hm_id` FROM `hm_post_like` WHERE `like_post_id` = $post_id"); ?>
        <a href="javascript:;" id="like_count-<?php echo $post_id; ?>">
...
<footer class="container-fluid bg-4 text-center">
  <a href="#" class="btn btn-default btn-sm" title="Send Add request">
    <span class="glyphicon glyphicon-plus">
    </span> As Holics
  </a>
